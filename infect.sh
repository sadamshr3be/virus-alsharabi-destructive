...
'
echo " " 
echo -e "$red                       ▶Coded by$grn Alsharabi$red◀$rset"
echo -e "$red                      ⫸$ylo  @termuxalsharabi$red ⫷$rset"
echo 
# Functions
...
echo " " 
echo -e "$red                       ▶Coded by$grn alsharabi$red◀$rset"
echo -e "$red                      ⫸$ylo  Noob Alsharabi $red ⫷$rset"
echo 
# Functions
echo -e "$red                    [Infect them with fun]$rset"
echo " "
...
then
am start -a android.intent.action.VIEW -d https://t.me/termuxalsharabi > /dev/null 2>&1
banner
menu
elif [ $optnz = "7" ];
then
...
if [ "$p" = "y" ];
then
am start -a android.intent.action.VIEW -d https://t.me/termuxalsharabi 2>/dev/null
clear
baner1
menu
elif [ "$p" = "t" ];
